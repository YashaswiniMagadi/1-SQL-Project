...
-- f. Generating gross total price 
	SELECT 
    	    s.date, 
            s.product_code, 
            p.product, 
...
-- g. Generate monthly gross sales report for Croma India for all the years
	SELECT 
            s.date, 
...
--h. Write a stored proc that can retrieve market badge. i.e. if total sold quantity > 5 million that market is considered "Gold" else "Silver"
